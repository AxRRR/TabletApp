...
import { useClickNumber } from '../../hooks/Calculator/useClickNumber';
// import { useClickOperator } from '../../hooks/Calculator/useClickOperator';
...
export const CalculatorApp = (props) => {
    ...
    const { result, history } = useClickNumber(numberSelect, operatorSelect);
    // const { result, history } = useClickOperator(operatorSelect, resultt);
